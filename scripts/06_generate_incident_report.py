...
def generate_incident_report(outputs_dir):
    ...
    lines = [
        ...
        f"| Autoencoder | {_metric(anomaly.get('autoencoder_report', {}).get('1', {}).get('f1-score'))} | not reported | Reconstruction anomaly detection |",
        f"| Isolation Forest | {_metric(anomaly.get('isolation_forest_report', {}).get('1', {}).get('f1-score'))} | not reported | Tree-based anomaly detection |",
