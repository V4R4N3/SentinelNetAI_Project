# SentinelNet Final Submission Checklist
...
- [x] Model checkpoints and preprocessing artifacts are present.
- [x] Metrics, alerts, incident report, response plan, and execution log are present.
- [x] Alert risk components sum to the reported score.
- [x] Response recommendations are dry-run and require human approval.

## Report Package

- [x] Required report sections are populated.
- [x] Model comparison table is populated.
- [x] Three alert investigations are populated.
- [x] Four required limitation statements are included verbatim.
- [x] Commands and output inventory are included.
- [x] Oral defense notes are included.
- [x] Presentation outline is included.
...
- [ ] Keep the upload receipt or confirmation screenshot.
